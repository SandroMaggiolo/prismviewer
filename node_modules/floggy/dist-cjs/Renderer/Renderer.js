        ...
        if (contextFitsSingleLine) {
            contextRendered =
                renderEl(exports.separators.context.singleLine) +
                    ...
                    ([key, value]) => `${chalk_1.chalk.gray(key)}${renderEl(exports.separators.contextKeyVal.singleLine)}${value}`)
            ...
            contextRendered =
                renderEl(exports.separators.context.multiline) +
                    ...
                    contextEntriesRendered
                        .map(([key, value]) => 
                    // eslint-disable-next-line
                    `${chalk_1.chalk.gray(utils.clampSpace(widestKey, key))}${renderEl(exports.separators.contextKeyVal.multiline
                    // eslint-disable-next-line
                    )}${formatBlock(value, {
