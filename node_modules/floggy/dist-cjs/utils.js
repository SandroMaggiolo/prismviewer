...
function parseFromEnvironment(key, parser) {
    ...
    if (result === null) {
        throw new Error(`Could not parse environment variable ${key} into ${parser.info.typeName}. The environment variable was: ${(0, util_1.format)(envVarValue)}. A valid environment variable must be like: ${parser.info.valid}`);
    }
    return result;
}
