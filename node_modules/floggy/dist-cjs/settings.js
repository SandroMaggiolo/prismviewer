...
const Filter = (0, tslib_1.__importStar)(require("./filter"));
const Level = (0, tslib_1.__importStar)(require("./level"));
const Output = (0, tslib_1.__importStar)(require("./output"));
...
function processSettingInputData(data, previous) {
    if (!previous) {
        return {
            ...defaultSettingData(),
            ...(0, utils_1.omitUndefinedKeys)(data)
        };
    }
    return {
        ...previous,
        ...(0, utils_1.omitUndefinedKeys)(data !== null && data !== void 0 ? data : {})
    };
}
...
function defaultFilterSetting() {
    ...
    if ((_a = process.env) === null || _a === void 0 ? void 0 : _a.LOG_LEVEL) {
        level = (0, utils_1.parseFromEnvironment)('LOG_LEVEL', Level.parser);
    }
    else {
